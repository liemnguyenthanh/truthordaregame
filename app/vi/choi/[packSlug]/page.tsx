...
export default async function GamePage({params}:{params:Promise<{packSlug:string}>}){const p=getPack((await params).packSlug);if(!p)notFound();return <><SiteHeader/><main id="main"><Game pack={p}/><OfflinePack pack={p}/></main></>;}
